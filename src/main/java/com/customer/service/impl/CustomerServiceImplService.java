 ...
 * 
 */
@WebServiceClient(name = "CustomerServiceImplService", targetNamespace = "http://impl.service.customer.com/", wsdlLocation = "file:/C:/Users/grahul/Desktop/wsdl/customerserviceimpl.wsdl")
    ...
    extends Service
{
    ...
    private final static QName CUSTOMERSERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.customer.com/", "CustomerServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/grahul/Desktop/wsdl/customerserviceimpl.wsdl");
    ...
    public CustomerServiceImpl getCustomerServiceImplPort() {
        return super.getPort(new QName("http://impl.service.customer.com/", "CustomerServiceImplPort"), CustomerServiceImpl.class);
    }
    ...
    public CustomerServiceImpl getCustomerServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.customer.com/", "CustomerServiceImplPort"), CustomerServiceImpl.class, features);
    }
